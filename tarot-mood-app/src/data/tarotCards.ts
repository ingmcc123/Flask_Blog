...
export const TAROT_CARDS: TarotCardData[] = [
  {
    ...
    recommendedFood: {
      name: '에그 베네딕트 브런치',
      reason: '가볍고 새로운 하루를 여는 음식이 지금의 설렘과 잘 어울려요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '불고기 덮밥',
      reason: '든든한 한 끼가 실행력을 북돋아 주고, 에너지를 채워 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '말차 푸딩 & 허브티',
      reason: '고요하게 즐기기 좋은 디저트로 내면의 목소리에 집중해 보세요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '딸기 티라미수',
      reason: '달콤한 디저트가 마음을 부드럽게 열어 주고, 사랑의 감정과 잘 맞아요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '닭가슴살 샐러드 볼',
      reason: '가볍지만 영양 가득한 한 끼가 앞으로 나아가는 힘을 더해 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '삼계탕',
      reason: '따뜻한 보양식이 지친 몸과 마음을 부드럽게 감싸 안아 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '따뜻한 된장찌개 정식',
      reason: '혼자 조용히 즐기기 좋은 집밥이 외로움을 위로해 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '회전초밥',
      reason: '다양한 맛을 골라 먹는 즐거움이 변화의 흐름을 가볍게 받아들이게 해요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '우동',
      reason: '담백하고 따뜻한 국물이 급한 마음을 잠시 멈추게 해 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '크림 파스타',
      reason: '새로운 맛의 파스타가 전환의 시기에 작은 설렘을 더해 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '비빔밥',
      reason: '골고루 섞인 한 그릇이 마음의 균형을 되찾는 데 도움이 될 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '매운 떡볶이',
      reason: '매콤한 맛이 쌓인 스트레스를 시원하게 풀어 주고, 기분 전환에 좋아요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '순두부찌개',
      reason: '뜨끈한 찌개가 흔들리는 마음을 따뜻하게 안정시켜 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '미역국',
      reason: '맑고 따뜻한 국물이 상처받은 마음을 조용히 치유해 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '호떡 & 따뜻한 우유',
      reason: '달콤하고 따뜻한 간식이 불안한 밤의 마음을 포근하게 달래 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '망고 빙수',
      reason: '시원하고 달콤한 디저트가 오늘의 밝은 기분을 한층 더 살려 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '회덮밥',
      reason: '깔끔하고 상큼한 한 그릇이 새출발의 마음을 상쾌하게 정리해 줄 거예요.',
    },
  ...
  },
  {
    ...
    recommendedFood: {
      name: '한상차림 정식',
      reason: '풍성한 한 상이 지금까지의 여정을 축하하고, 완성의 기쁨을 더해 줄 거예요.',
    },
